...
try
{
    ...
    String one=jTextField2.getText();
    ...
    PreparedStatement st=(PreparedStatement) connection.prepareStatement("insert into temlist values(?,?,?,?,?)");
    st.setString(1,one);
    st.setString(2,two);
    st.setString(3,three);
    st.setString(4,four);
    st.setString(5,five);
